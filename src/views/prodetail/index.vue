  ...
  <div class="prodetail">
    ...
    <div class="comment">
      <div class="comment-title">
        <div class="left">商品评价 ({{ commen.total }}条)</div>
        <div class="right">查看更多 <van-icon name="arrow" /></div>
      </div>
      <div class="comment-list">
        <div class="comment-item" v-for="item in commen.list" :key="item.commen_id">
          <div class="top">
...
export default {
  ...
  methods: {
    ...
    async getComments() {
      const { data } = await getProComments(this.goodsId, 3)
      this.commen = data
      console.log(data)
    }
  },
